...
const LayoutLayerTrait: TraitDefinition = {
  trait: {
    name: 'LayoutLayer',
    version: '0.1.0',
    description: 'Controls sequencing and blending of layered mark definitions.',
    category: 'viz.layout',
    tags: ['viz', 'layout', 'layer', 'composition'],
  },
...
export default LayoutLayerTrait;
