...
const EncodingPositionYTrait = {
  trait: {
    name: 'EncodingPositionY',
    version: '0.1.0',
    description: 'Binds a data field to the vertical axis with aggregation hints.',
    category: 'viz.encoding',
    tags: ['viz', 'encoding', 'y-axis', 'position'],
  },
  ...
  parameters: [
    {
      ...
      default: ['quantitative', 'temporal', 'ordinal'],
    },
    {
      name: 'defaultScale',
      type: 'string',
...
export default EncodingPositionYTrait;
